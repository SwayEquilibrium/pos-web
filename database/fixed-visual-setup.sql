-- Fixed Complete Visual Customization Setup
...
-- Step 4: Image management functions (FIXED PARAMETER ORDER)
...
-- FIXED: All parameters with defaults moved to the end
...
DROP POLICY IF EXISTS "Anyone can view optimized images" ON public.optimized_images;
DROP POLICY IF EXISTS "Authenticated users can upload images" ON public.optimized_images;
DROP POLICY IF EXISTS "Users can update own images" ON public.optimized_images;
